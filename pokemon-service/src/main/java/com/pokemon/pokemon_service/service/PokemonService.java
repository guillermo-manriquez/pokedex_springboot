...
public class PokemonService {
    ...
    public Pokemon obtenerPokemonPorId(Integer id) {
        ...
        try {
            ...
            pokemon.setExperienciaBase(
                    root.get("base_experience").asInt()
            );


            // IMAGEN
            pokemon.setImagenUrl(
                    root.get("sprites")
                            .get("front_default")
                            .asText()
            );
            ...
            JsonNode speciesRoot =
                    mapper.readTree(speciesJson);


            // DESCRIPCION
            JsonNode descriptions =
                    speciesRoot.get("flavor_text_entries");
